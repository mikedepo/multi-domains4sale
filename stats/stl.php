...
http://journalxtra.com/2011/04/really-simple-traffic-logger/

INSTRUCTIONS

In the zip file is a folder called 'stats'. This folder contains the executable script called stl.php, a subdirectory called 'data', a readme file and the executable script called stl.php.
...
# NOT REALLY CONFIGURABLE VARIABLES (except, maybe, file names)
  ...
  # File names
    ...
    $tally = "tally.txt" ;
  # Access details
    if (isset($_SERVER['SERVER_NAME'])) {$server_domain = $_SERVER['SERVER_NAME'];} else {$server_domain = "NULL1";}
  ...
  # Log file's contents
/* Oriignal:    $log_file_content = "\"$date\","."\"$time\","."\"$ip\","."\"$hostname\","."\"$referrer\","."\"$agent\","."\"$page\","."\"$doc_root\","."\"$script\","."\"$path\","."\"$looking_for\","."\"$keywords\"";
    $log_file_header = "\"DATE\","."\"TIME\","."\"IP\","."\"HOSTNAME\","."\"REFERRER\","."\"AGENT\","."\"PAGE\","."\"DOC_ROOT\","."\"SCRIPT\","."\"PATH\","."\"LOOKING_FOR\","."\"KEYWORDS\"";
*/

    $log_file_content = "\"$date\","."\"$time\","."\"$ip\","."\"$hostname\","."\"$referrer\","."\"$agent\","."\"$page\","."\"$server_domain\","."\"$script\","."\"$path\","."\"$looking_for\","."\"$keywords\"";
    $log_file_header = "\"DATE\","."\"TIME\","."\"IP\","."\"HOSTNAME\","."\"REFERRER\","."\"AGENT\","."\"PAGE\","."\"SERVER_DOMAIN\","."\"SCRIPT\","."\"PATH\","."\"LOOKING_FOR\","."\"KEYWORDS\"";
